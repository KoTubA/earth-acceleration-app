    ...
    <section className="flex justify-center w-full">
      <div className="flex flex-col items-center py-16 px-7 lg:px-14 xl:px-20 max-w-screen-xl w-full">
        ...
        <div className="flex flex-col md:flex-row mb-9">
          <div className="bg-stone-200 h-64 w-full rounded-md mb-6 md:flex-1 md:basis-6/12 md:mr-3 lg:mr-6 xl:mr-12"></div>
        ...
        <div className="flex flex-col md:flex-row-reverse mb-9">
          <div className="bg-stone-200 h-64 w-full rounded-md mb-6 md:flex-1 md:basis-6/12 md:ml-3 lg:ml-6 xl:ml-12"></div>
