...
const Home = () => {
  return (
    <section className="flex justify-center w-full">
      <div className="flex flex-col pt-2.5 pb-14 px-7 lg:px-14 xl:px-20 md:flex-row-reverse md:items-center md:pt-14 max-w-screen-xl w-full">
        <div className="bg-stone-200 h-64 w-full rounded-md mb-7 lg:h-80 md:flex-1 md:basis-7/12"></div>
