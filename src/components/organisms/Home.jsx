...
const Home = () => {
  return (
    <section className="flex justify-center w-full">
      <div className="flex flex-col pt-4 pb-20 px-7 lg:px-14 xl:px-20 md:flex-row-reverse md:items-center md:pt-14 max-w-screen-xl w-full">
        ...
        <div className="flex flex-col items-center md:items-start md:mr-8 lg:mr-16 xl:mr-24 md:flex-1 md:basis-5/12">
          <h1 className="text-5xl md:text-4xl lg:text-5xl font-bold text-center font-display md:text-start">
            Kalkulator przyspieszenia ziemskiego
          </h1>
          <p className="lg:text-lg my-6 text-center font-display md:text-start text-neutral-600">
