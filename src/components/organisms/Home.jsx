...
const Home = () => {
  return (
    <section className="flex justify-center w-full">
      <div className="flex flex-col pt-4 pb-20 px-7 lg:px-14 xl:px-20 md:flex-row-reverse md:items-center md:pt-14 max-w-screen-xl w-full md:gap-x-1 lg:gap-x-4 xl:gap-x-24">
        ...
        <div className="flex flex-col items-center md:items-start md:mr-10 xl:mr-0 md:flex-1 md:basis-5/12">
          <h1 className="text-3xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-center font-display md:text-start">
